...
namespace SentimentAnalysis
{
    class Program
    {
        private static readonly string _appPath = Path.GetDirectoryName(Environment.GetCommandLineArgs()[0]);
        private static readonly string _dataPath = Path.Combine(_appPath, "..", "..", "..", "Data", "yelp_labelled.txt");
